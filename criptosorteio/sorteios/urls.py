...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/editar/$', views.editar_sorteio, name='editar-sorteio'),
    url(r'^(?P<pk>\d+)/sair/$', views.sair_sorteio, name='sair-sorteio'),
    url(r'^(?P<pk>\d+)/deletar/$', views.deletar_sorteio, name='deletar-sorteio'),
